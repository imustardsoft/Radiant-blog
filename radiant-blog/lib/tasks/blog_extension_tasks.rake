  ...
  namespace :extensions do
    namespace :blog do
      ...
      task :update => :environment do
        ...
        unless BlogExtension.root.starts_with? RAILS_ROOT # don't need to copy vendored tasks
          puts "Copying rake tasks from BlogExtension"
          local_tasks_path = File.join(RAILS_ROOT, %w(lib tasks))
          mkdir_p local_tasks_path, :verbose => false
          Dir[File.join BlogExtension.root, %w(lib tasks *.rake)].each do |file|
